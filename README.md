# 🕯️ Candlestick Pattern Counter

**[🌐 Live Demo → candlestick-counter.com](https://candlestick-counter.com)**

A free, feature-rich web tool for traders to count, record, and analyze candlestick patterns in real time.
...
- **Multilingual** — Japanese, English, Chinese, German, French, Spanish

---

## 🚀 Getting Started

No installation required. Simply open the link below in your browser:

👉 **[https://candlestick-counter.com](https://candlestick-counter.com)**
...
© 2026 [Harutineria](https://github.com/harutineria)

---

## 🔗 Links

- 🌐 [Live App](https://candlestick-counter.com)
- 🔒 [Privacy Policy](https://candlestick-counter.com/privacy.html)
- 📋 [Terms of Service](https://candlestick-counter.com/terms.html)
...
**[🌐 アプリを開く → candlestick-counter.com](https://candlestick-counter.com)**

トレーダーのためのローソク足パターンをカウント・記録・分析できる無料のWebツールです。
...
- **多言語対応** — 日本語・英語・中国語・ドイツ語・フランス語・スペイン語

---

## 🚀 使い方

インストール不要です。ブラウザで以下のURLを開くだけです：

👉 **[https://candlestick-counter.com](https://candlestick-counter.com)**

PC・スマホどちらのブラウザでも動作します。

---

## 🛠️ 技術スタック

- HTML / CSS / JavaScript（単一ファイルのWebアプリ）
- Chart.js 4.4.1
- Service Worker（PWA）
...
- 🌐 [アプリ](https://candlestick-counter.com)
- 🔒 [プライバシーポリシー](https://candlestick-counter.com/privacy.html)
- 📋 [利用規約](https://candlestick-counter.com/terms.html)

---
---

# 🕯️ Contador de Patrones de Velas Japonesas

**[🌐 Demo en vivo → candlestick-counter.com](https://candlestick-counter.com)**

Una herramienta web gratuita y completa para que los traders cuenten, registren y analicen patrones de velas japonesas en tiempo real.
...
- **Multilingüe** — Japonés, Inglés, Chino, Alemán, Francés, Español

---

## 🚀 Cómo Empezar

No se requiere instalación. Simplemente abre el siguiente enlace en tu navegador:
...
- HTML / CSS / JavaScript puro (aplicación de un solo archivo)
- Chart.js 4.4.1
- Service Worker (PWA)
...
- 🌐 [Aplicación en vivo](https://candlestick-counter.com)
- 🔒 [Política de Privacidad](https://candlestick-counter.com/privacy.html)
- 📋 [Términos de Servicio](https://candlestick-counter.com/terms.html)
